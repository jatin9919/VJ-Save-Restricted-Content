...
API_ID = int(os.environ.get("API_ID", "31306880"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "a791ca6200ab2561145d05353abc2e89")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "8586749361"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://jokernxmber1_db_user:bb2rfwbbj67XCW0l@cluster0.atigfjc.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
